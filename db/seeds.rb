...
for i in 1..10 do
  Print.create!(product_id:"#{i}",avatar: open("https://timgsa.baidu.com/timg?image&quality=80&size=b9999_10000&sec=1494473873065&di=e451a498d2d4254ab66d00e3dd023373&imgtype=0&src=http%3A%2F%2Fleiphone.qiniudn.com%2Fuploads%2Fnew%2Farticle%2Fpic%2F201505%2F555b4b908753b.jpg"))
  Print.create!(product_id:"#{i}",avatar: open("http://www.laptopmag.com/images/uploads/ppress/44891/apple-macbook-pro-13-2016-nw-g02.jpg"))
  Print.create!(product_id:"#{i}",avatar: open("http://cdn.cultofmac.com/wp-content/uploads/2016/11/MacBook-Pro-with-Touch-Bar-2-1-780x520.jpg"))
  Print.create!(product_id:"#{i}",avatar: open("http://www.computershopper.com/var/ezwebin_site/storage/images/media/images/apple-macbook-pro-2016-front-angle/1295295-2-eng-US/apple-macbook-pro-2016-front-angle.jpg"))
  puts("上传#{i}号产品的描述图片")
end
